...
class GraphProperties:
    def __init__(
        self, graph: Graph, resolution: float = 0.7, random_state: int = 34
    ) -> None:
        self.graph = graph
        ...
        self.node_grades = {"Smart Cities": 2, "Intelligence": 4, "Robotics": 6}
    ...
    def __get_line_properties(self):
        ...
        for n in self.graph.nodes():
            if n in self.node_grades.keys():
                line_widths.append(self.node_grades.get(n))
